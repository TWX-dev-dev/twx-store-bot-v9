...
async def comandos_loja(interaction: discord.Interaction):
    texto = (
        ...
        "**Produtos e estoque**\n"
        "/categoria_add, /categoria_editar, /categoria_remover, /categoria_banner, /produto_add, /produto_editar, /set_preco, /produto_info, /produto_remover, /produtos, /estoque_set, /estoque_add_qtd, /estoque_rem_qtd, /estoque_add, /estoque_ver\n\n"
